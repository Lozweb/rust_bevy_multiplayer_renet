...
pub(super) fn plugin(app: &mut App) {
    ...
    app.add_systems(
        ...
        (
            ...
            check_spash_timer.in_set(AppSystems::Update),
        )
            .run_if(in_state(Screen::Splash)),
    );
...
fn spawn_splash_screen(mut commands: Commands, asset_server: Res<AssetServer>) {
    commands.spawn((
        ...
        children![(
            ...
            ImageNodeFadeInOut {
                total_duration: SPLASH_FADE_DURATION_SECS,
...
fn check_spash_timer(timer: ResMut<SplashTimer>, mut next_screen: ResMut<NextState<Screen>>) {
