...
use crate::{menu::Menu, screens::Screen, theme::widget};
use bevy::prelude::*;
use game_core::asset_tracking::ResourceHandles;
...
#[cfg(not(target_family = "wasm"))]
fn exit_app(_: On<Pointer<Click>>, mut app_exit_events: MessageWriter<AppExit>) {
